    ...
    <body>
        ...
        <header class="l-header" id="header">
            <nav class="nav bd-container">
                <a href="#" class="nav__logo">FAST FOODS</a>

                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        <li class="nav__item"><a href="#home" class="nav__link active-link">Home</a></li>
                        <li class="nav__item"><a href="#share" class="nav__link">Share</a></li>
                        <li class="nav__item"><a href="#decoration" class="nav__link">Specials</a></li>
        ...
        <main class="l-main">
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__img">
                        <img src="assets/img/pexels-horizon-content-3738730-removebg-preview.png" alt="">
                    </div>
            ...
            <section class="share section bd-container" id="share">
                <div class="share__container bd-grid">
                    ...
                    <div class="share__img">
                        <img src="assets/img/soda bugger.jpg" alt="">
                    </div>
                </div>
            </section>
            ...
            <section class="decoration section bd-container" id="decoration">
                <h2 class="section-title">Today's Special Deals <br> Just For You</h2>
                <div class="decoration__container bd-grid">
                    <div class="decoration__data">
                        <img src="assets/img/pexels-rajesh-tp-1624487.jpg" alt="" class="decoration__img">
                        <h3 class="decoration__title">Chicken Biryani</h3>
                        <a href="#" class="button button-link">Go Shopping</a>
                    </div>

                    <div class="decoration__data">
                        <img src="assets/img/pexels-daria-shevtsova-1260968.jpg" alt="" class="decoration__img">
                        <h3 class="decoration__title">Vegies Pizza</h3>
                        <a href="#" class="button button-link">Go Shopping</a>
                    </div>

                    <div class="decoration__data">
                        <img src="assets/img/pexels-chevanon-photography-312418.jpg" alt="" class="decoration__img">
                        <h3 class="decoration__title">Doppio coffee</h3>
                        <a href="#" class="button button-link">Go Shopping</a>
                    </div>
                </div>
            </section>
            ...
            <section class="accessory section bd-container" id="accessory">
                <h2 class="section-title">What's on The <br> Menu Today</h2>
